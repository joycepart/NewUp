...
public class LoadingAndRetryManager {
	...
	public LoadingAndRetryManager(Object activityOrFragmentOrView,
			OnLoadingAndRetryListener listener) {
		...
		if (activityOrFragmentOrView instanceof Activity) {
			...
			context = activity;
			contentParent = (ViewGroup) activity
			...
			throw new IllegalArgumentException(
					"the argument's type must be Fragment or Activity");
		}
		...
		LoadingAndRetryLayout loadingAndRetryLayout = new LoadingAndRetryLayout(
				context);
